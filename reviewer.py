...
# def get_quez(list_of_quez):
#     temp = random.choice(range(0, len(list_of_quez)))
#     print(list_of_quez[temp])
#     return temp

# def get_choices(list_of_ans, temp):
#     print(random.choices(list_of_ans, k = 3))
